    ...
    KTUtil.data(e).has("blockui") ? (n = KTUtil.data(e).get("blockui")) : r(),
      ...
      (n.release = function () {
        !1 !== KTEventHandler.trigger(n.element, "kt.blockui.release", n) &&
          (n.element.classList.add("blockui"), n.positionChanged && KTUtil.css(n.element, "position", ""), n.overflowChanged && KTUtil.css(n.element, "overflow", ""), n.overlayElement && KTUtil.remove(n.overlayElement), (n.blocked = !1), KTEventHandler.trigger(n.element, "kt.blockui.released", n));
      }),
...
(KTMenu.getInstance = function (e) {
  var t;
  if (!e) return null;
  console.log(KTUtil.data(e).has("menu"));
  KTUtil.data(e).set("menu", n);
    ...
    actualCss: function (e, t, n) {
      ...
      if (e instanceof HTMLElement != !1)
        return e.getAttribute("kt-hidden-" + t) && !1 !== n
          ...
          : ((r = e.style.cssText), (e.style.cssText = "position: absolute; visibility: hidden; display: block;"), "width" == t ? (i = e.offsetWidth) : "height" == t && (i = e.offsetHeight), (e.style.cssText = r), e.setAttribute("kt-hidden-" + t, i), parseFloat(i));
    },
        ...
        (function () {
          ...
          KTUtil.on(u, "[data-kt-mode]", "click", function (n) {
            ...
            (e.innerText = i),
              ...
              this.classList.add("active"),
              "image" === r ? (a.classList.remove("d-none"), a.classList.add("d-block"), l.classList.remove("d-block"), l.classList.add("d-none")) : (l.classList.remove("d-none"), l.classList.add("d-block"), a.classList.remove("d-block"), a.classList.add("d-none"));
          });
        })()),
      a &&
        s &&
