...
let e = document.getElementById("formValidationExamples"),
  ...
  i = FormValidation.formValidation(e, {
    fields: {
      formValidationName: {
        validators: { notEmpty: { message: "Please enter your name" }, stringLength: { min: 6, max: 30, message: "The name must be more than 6 and less than 30 characters long" }, regexp: { regexp: /^[a-zA-Z0-9 ]+$/, message: "The name can only consist of alphabetical, number and space" } },
      },
...
s &&
  ...
  a.length &&
    ...
    a.select2({ placeholder: "Select country", dropdownParent: a.parent() }).on("change", function () {
  ...
  t.typeahead(
    { hint: !isRtl, highlight: !0, minLength: 1 },
    {
      name: "tech",
      source:
        ((l = ["ReactJS", "Angular", "VueJS", "Html", "Css", "Sass", "Pug", "Gulp", "Php", "Laravel", "Python", "Bootstrap", "Material Design", "NodeJS"]),
        function (e, a) {
          var t = [],
            o = new RegExp(e, "i");
          $.each(l, function (e, a) {
