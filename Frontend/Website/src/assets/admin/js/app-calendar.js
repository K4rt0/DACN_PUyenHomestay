...
let D = new Calendar(e, {
  ...
  eventClick: function (e) {
    (e = e),
      (E = e.event).url && (e.jsEvent.preventDefault(), window.open(E.url, "_blank")),
      q.show(),
...
FormValidation.formValidation(Y, {
  ...
  d.addEventListener("click", (e) => {
    var t, n;
    d.classList.contains("btn-add-event")
      ? w &&
        ((n = { id: D.getEvents().length + 1, title: c.value, start: u.value, end: v.value, startStr: u.value, endStr: v.value, display: "block", extendedProps: { location: g.value, guests: f.val(), calendar: p.val(), description: h.value } }),
        ...
        q.hide())
      : w &&
        ((n = { id: E.id, title: c.value, start: u.value, end: v.value, url: m.value, extendedProps: { location: g.value, guests: f.val(), calendar: p.val(), description: h.value }, display: "block", allDay: !!b.checked }),
