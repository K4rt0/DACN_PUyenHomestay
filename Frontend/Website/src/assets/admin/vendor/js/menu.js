              ...
              value: function (t, n) {
                ...
                for (var r = 0, s = (i = i.slice(0, i.indexOf(o))).length; r < s; r++)
                  if ((i[r].classList.add("open"), this._accordion))
                    for (var l = e._findChild(i[r].parentNode, ["menu-item", "open"]), a = 0, u = l.length; a < u; a++) if (l[a] !== i[r] && (l[a].classList.remove("open"), n)) for (var c = l[a].querySelectorAll(".menu-item.open"), d = 0, h = c.length; d < h; d++) c[d].classList.remove("open");
                return o;
              },
            },
            {
