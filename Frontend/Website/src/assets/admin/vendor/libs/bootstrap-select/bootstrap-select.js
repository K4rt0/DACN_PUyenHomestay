          ...
          !(function (e) {
            ...
            (h = null),
              ...
              String.prototype.startsWith ||
                ...
                Object.defineProperty ? Object.defineProperty(String.prototype, "startsWith", { value: d, configurable: !0, writable: !0 }) : (String.prototype.startsWith = d));
            ...
            var P = 0,
              W = ".bs.select",
              B = { DISABLED: "disabled", DIVIDER: "divider", SHOW: "open", DROPUP: "dropup", MENU: "dropdown-menu", MENURIGHT: "dropdown-menu-right", MENULEFT: "dropdown-menu-left", BUTTONCLASS: "btn-default", POPOVERHEADER: "popover-title", ICONBASE: "glyphicon", TICKICON: "glyphicon-ok" },
              R = { MENU: "." + B.MENU, DATA_TOGGLE: 'data-toggle="dropdown"' },
              j = {
            ...
            var U = new RegExp("38|40"),
              ...
              _ = {
                ...
                text: function (e, t) {
                  ...
                  if (!0 === t) for (; n.childNodes.length > 0; ) j.fragment.appendChild(n.childNodes[0]);
            ...
            var K = function (t, i) {
              ...
              g.useDefault || ((e.valHooks.select.set = g._set), (g.useDefault = !0)),
                ...
                (this.options = i),
                (this.selectpicker = {
                  main: { data: [], optionQueue: j.fragment.cloneNode(!1), hasMore: !1 },
            ...
            function Q(i) {
              ...
              if (([].shift.apply(n), !M.success)) {
                try {
                  ...
                  K.BootstrapVersion
                    ? (M.full = K.BootstrapVersion.split(" ")[0].split("."))
                    : ((M.full = [M.major, "0", "0"]),
                      console.warn(
              ...
              if (M.major >= "4") {
                var l = [];
                K.DEFAULTS.style === B.BUTTONCLASS && l.push({ name: "style", className: "BUTTONCLASS" }),
                  K.DEFAULTS.iconBase === B.ICONBASE && l.push({ name: "iconBase", className: "ICONBASE" }),
                  K.DEFAULTS.tickIcon === B.TICKICON && l.push({ name: "tickIcon", className: "TICKICON" }),
              ...
              (K.prototype = {
                ...
                init: function () {
                  ...
                  P++,
                    ...
                    s.hasAttribute("required") &&
                      this.$element.on("invalid" + W, function () {
                        t.$button[0].classList.add("bs-invalid"),
                          t.$element
                            .on("shown" + W + ".invalid", function () {
                ...
                createDropdown: function () {
                  ...
                  var o,
                    ...
                    d = "";
                  return (
                    this.options.header && (l = '<div class="' + B.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                ...
                createView: function (t, i, s) {
                  ...
                  function h(e, i) {
                    ...
                    if (
                      ...
                      void 0 !== n.activeElement && (i && (n.activeElement !== n.selectedElement && n.defocusItem(n.activeElement), (n.activeElement = void 0)), n.activeElement !== n.selectedElement && n.defocusItem(n.selectedElement)),
                      ...
                      if (
                        ((u = n.selectpicker.view.visibleElements ? n.selectpicker.view.visibleElements.slice() : []),
                        ...
                        if (
                          (n.options.sanitize && O.length && r(O, n.options.whiteList, n.options.sanitizeFn),
                          !0 === w
                            ? ((y = 0 === n.selectpicker.view.position0 ? 0 : n.selectpicker.current.data[n.selectpicker.view.position0 - 1].position),
                  ...
                  h(o, !0),
                    ...
                    e(window)
                      .off("resize" + W + "." + this.selectId + ".createView")
                      .on("resize" + W + "." + this.selectId + ".createView", function () {
                ...
                buildData: function (t, i) {
                  ...
                  function u(e, i) {
                    ...
                    if (u.length) {
                      var f,
                        m,
                        g = { display: D(n(v, "label")), subtext: n(s, "subtext"), icon: n(s, "icon"), type: "optgroup-label", optgroupClass: " " + (s.className || ""), optgroup: s };
                      a++, r && h({ optID: a }), (g.optID = a), l.push(g);
                      for (var b = 0, w = u.length; b < w; b++) {
                        var k = u[b];
                        0 === b && (m = (f = l.length - 1) + w), p(k, { headerIndex: f, lastIndex: m, optID: g.optID, optgroupClass: g.optgroupClass, disabled: s.disabled });
                      }
                      d && h({ optID: a });
                    }
                  }
                ...
                render: function (e) {
                  ...
                  if (
                    ...
                    u = _.text.call(this, { text: this.options.placeholder }, !0);
                    ...
                    if (!o) {
                      for (var g = 0; g < a && g < 50; g++) {
                        var b = l[g],
                          w = {};
                        b &&
                          (this.multiple && g > 0 && u.appendChild(p.cloneNode(!1)),
                          b.title ? (w.text = b.title) : b.content && s.options.showContent ? ((w.content = b.content.toString()), (f = !0)) : (s.options.showIcon && (w.icon = b.icon), s.options.showSubtext && !s.multiple && b.subtext && (w.subtext = " " + b.subtext), (w.text = b.text.trim())),
                  ...
                  if (
                    (u.childNodes.length || (u = _.text.call(this, { text: this.options.placeholder ? this.options.placeholder : this.options.noneSelectedText }, !0)),
                ...
                liHeight: function (t) {
                  if (t || (!1 !== this.options.size && !Object.keys(this.sizeInfo).length)) {
                    ...
                    var w,
                      ...
                      A = n.offsetWidth,
                      T = { vert: I(O.paddingTop) + I(O.paddingBottom) + I(O.borderTopWidth) + I(O.borderBottomWidth), horiz: I(O.paddingLeft) + I(O.paddingRight) + I(O.borderLeftWidth) + I(O.borderRightWidth) },
                      z = { vert: T.vert + I(O.marginTop) + I(O.marginBottom) + 2, horiz: T.horiz + I(O.marginLeft) + I(O.marginRight) + 2 };
                ...
                getSelectPosition: function () {
                  ...
                  i.options.container && o.length && !o.is("body") ? (((t = o.offset()).top += parseInt(o.css("borderTopWidth"))), (t.left += parseInt(o.css("borderLeftWidth")))) : (t = { top: 0, left: 0 });
                ...
                setSize: function (t) {
                  if ((this.liHeight(t), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size)) {
                    ...
                    this.setMenuSize(),
                      ...
                      "auto" === this.options.size
                        ? s.off("resize" + W + "." + this.selectId + ".setMenuSize scroll" + W + "." + this.selectId + ".setMenuSize").on("resize" + W + "." + this.selectId + ".setMenuSize scroll" + W + "." + this.selectId + ".setMenuSize", function () {
                            return i.setMenuSize();
                          })
                ...
                selectPosition: function () {
                  ...
                  var t,
                    ...
                    l = function (l) {
                      ...
                      n.$bsContainer.addClass(l.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(B.DROPUP, l.hasClass(B.DROPUP)),
                        ...
                        (M.major < 4 || "static" === a) && ((r.top = t.top - i.top + s), (r.left = t.left - i.left)),
                  ...
                  this.$button.on("click.bs.dropdown.data-api", function () {
                    ...
                    e(window)
                      .off("resize" + W + "." + this.selectId + " scroll" + W + "." + this.selectId)
                      .on("resize" + W + "." + this.selectId + " scroll" + W + "." + this.selectId, function () {
                ...
                setSelected: function (e, t) {
                  ...
                  n &&
                    ...
                    l ? (this.focusItem(n, e), (this.selectpicker.view.currentActive = n), (this.activeElement = n)) : this.defocusItem(n),
                    ...
                    l || o || !t || void 0 === this.prevActiveElement || ((i = this.prevActiveElement), this.defocusItem(i)));
                },
                ...
                checkDisabled: function () {
                  this.isDisabled()
                    ? (this.$newElement[0].classList.add(B.DISABLED), this.$button.addClass(B.DISABLED).attr("aria-disabled", !0))
                    : this.$button[0].classList.contains(B.DISABLED) && (this.$newElement[0].classList.remove(B.DISABLED), this.$button.removeClass(B.DISABLED).attr("aria-disabled", !1));
                },
                    ...
                    this.$menuInner.on("click", "li a", function (i, s) {
                      ...
                      if ((t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(), i.preventDefault(), !t.isDisabled() && !n.parent().hasClass(B.DISABLED))) {
                          ...
                          if ((t.setSelected(r, !w), t.focusedParent.focus(), !1 !== E || !1 !== $)) {
                            ...
                            if ((E && S) || ($ && A))
                              if (E && 1 === E) (o.selectedIndex = -1), t.setOptionStatus(!0);
                                ...
                                D[2] && ((L = L.replace("{var}", D[2][E > 1 ? 0 : 1])), (N = N.replace("{var}", D[2][$ > 1 ? 0 : 1]))),
                                  t.$menu.append(H),
                                  E && S && (H.append(e("<div>" + L + "</div>")), (u = !1), t.$element.trigger("maxReached" + W)),
                                  $ && A && (H.append(e("<div>" + N + "</div>")), (u = !1), t.$element.trigger("maxReachedGrp" + W)),
                                  setTimeout(function () {
                                    t.setSelected(r, !1);
                                  }, 10),
                        ...
                        t.options.source.data && t.$element[0].appendChild(t.selectpicker.main.optionQueue),
                          ...
                          u && (t.multiple || d !== o.selectedIndex) && ((b = [f.index, g.prop("selected"), c]), t.$element.triggerNative("change"));
                      }
                    }),
                      ...
                      if (((e.selectpicker.search.elements = []), (e.selectpicker.search.data = []), t))
                        if (((e.selectpicker.search.previousValue = t), e.options.source.search))
                          ...
                          for (var a = 0; a < e.selectpicker.main.data.length; a++) {
                            ...
                            n[a] || (n[a] = k(c, s, l, r)),
                              n[a] && void 0 !== c.headerIndex && -1 === o.indexOf(c.headerIndex) && (c.headerIndex > 0 && ((n[c.headerIndex - 1] = !0), o.push(c.headerIndex - 1)), (n[c.headerIndex] = !0), o.push(c.headerIndex), (n[c.lastIndex + 1] = !0)),
                    ...
                    if (!(s = c.$menu.hasClass(B.SHOW)) && (u || (t.which >= 48 && t.which <= 57) || (t.which >= 96 && t.which <= 105) || (t.which >= 65 && t.which <= 90)) && (c.$button.trigger("click.bs.dropdown.data-api"), c.options.liveSearch)) c.$searchbox.trigger("focus");
                      ...
                      if ((27 === t.which && s && (t.preventDefault(), c.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), u)) {
                        ...
                        -1 !== (i = (n = c.activeElement) ? Array.prototype.indexOf.call(n.parentElement.children, n) : -1) && c.defocusItem(n),
                          38 === t.which
                            ? (-1 !== i && i--, i + m < 0 && (i += d.length), c.selectpicker.view.canHighlight[i + m] || (-1 == (i = c.selectpicker.view.canHighlight.slice(0, i + m).lastIndexOf(!0) - m) && (i = d.length - 1)))
                            : (40 === t.which || p) && (++i + m >= c.selectpicker.view.canHighlight.length && (i = c.selectpicker.view.firstHighlightIndex), c.selectpicker.view.canHighlight[i + m] || (i = i + 1 + c.selectpicker.view.canHighlight.slice(i + m + 1).indexOf(!0))),
                          t.preventDefault();
                        var v = m + i;
                        38 === t.which
                          ? 0 === m && i === d.length - 1
                          ...
                          : (40 === t.which || p) && (i === c.selectpicker.view.firstHighlightIndex ? ((c.$menuInner[0].scrollTop = 0), (v = c.selectpicker.view.firstHighlightIndex)) : (o = c.selectpicker.current.data[v]) && (h = (l = o.position - c.sizeInfo.menuInnerHeight) > f)),
                        ...
                        if (w.length) {
                          ...
                          d.removeClass("active").find("a").removeClass("active"),
                            ...
                            (g = w[x]),
                            f - (o = c.selectpicker.main.data[g]).position > 0 ? ((l = o.position - o.height), (h = !0)) : ((l = o.position - c.sizeInfo.menuInnerHeight), (h = o.position > f + c.sizeInfo.menuInnerHeight)),
                      ...
                      s &&
                        ...
                        (32 !== t.which && t.preventDefault(), (c.options.liveSearch && 32 === t.which) || (c.$menuInner.find(".active a").trigger("click", !0), r.trigger("focus"), c.options.liveSearch || (t.preventDefault(), e(document).data("spaceSelect", !0))));
                    }
                },
                mobile: function () {
            ...
            (e.fn.selectpicker = Q),
              ...
              e(document)
                ...
                .on("keydown.bs.dropdown.data-api", ":not(.bootstrap-select) > [" + R.DATA_TOGGLE + "]", Z)
                .on("keydown.bs.dropdown.data-api", ":not(.bootstrap-select) > .dropdown-menu", Z)
                .on("keydown" + W, ".bootstrap-select [" + R.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', K.prototype.keydown)
                .on("focusin.modal", ".bootstrap-select [" + R.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function (e) {
                  e.stopPropagation();
                }),
