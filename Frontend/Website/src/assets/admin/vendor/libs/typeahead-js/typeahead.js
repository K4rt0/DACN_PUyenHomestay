                  ...
                  function r(t, r) {
                    ...
                    ((t = t || {}).templates = t.templates || {}),
                      ...
                      (this.templates = (function (t, i) {
                        return { notFound: t.notFound && n.templatify(t.notFound), pending: t.pending && n.templatify(t.pending), header: t.header && n.templatify(t.header), footer: t.footer && n.templatify(t.footer), suggestion: t.suggestion || r };
                        function r(t) {
                    ...
                    n.mixin(t.prototype, {
                      ...
                      moveCursor: function (t) {
                        ...
                        return (
                          ...
                          !((this._minLengthMet() && this.menu.update(e)) || this.eventBus.before("cursorchange", r) || (this.menu.setCursor(n), i ? this.input.setInputValue(i.val) : (this.input.resetInputValue(), this._updateHint()), this.eventBus.trigger("cursorchange", r), 0))
                        );
                      },
                      destroy: function () {
                        ...
                        return (
                          ...
                          this.each(function () {
                            ...
                            n.each(o, function (e) {
                              ...
                              p && p.val(""),
                              (i = (function (t, e) {
                                t.data(s.attrs, { dir: t.attr("dir"), autocomplete: t.attr("autocomplete"), spellcheck: t.attr("spellcheck"), style: t.attr("style") }), t.addClass(e.classes.input).attr({ autocomplete: "off", spellcheck: !1 });
                                try {
