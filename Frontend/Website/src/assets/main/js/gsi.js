...
(function (_) {
  ...
  try {
    ...
    (0, _._F_toggles_initialize)([0x2e244000, 0x760]);
    ...
    t("Map", function (a) {
      ...
      c.prototype.set = function (h, k) {
        ...
        m.V ? (m.V.value = k) : ((m.V = { next: this[1], ma: this[1].ma, head: this[1], key: h, value: k }), m.list.push(m.V), (this[1].ma.next = m.V), (this[1].ma = m.V), this.size++);
        return this;
      };
      c.prototype.delete = function (h) {
        h = d(this, h);
        return h.V && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this[0][h.id], (h.V.ma.next = h.V.next), (h.V.next.ma = h.V.ma), (h.V.head = null), this.size--, !0) : !1;
      };
      ...
      var d = function (h, k) {
          ...
          if (n && fa(h[0], m))
            for (h = 0; h < n.length; h++) {
              var p = n[h];
              if ((k !== k && p.key !== p.key) || k === p.key) return { id: m, list: n, index: h, V: p };
            }
...
*/
 ...
 SPDX-License-Identifier: Apache-2.0
*/
    var Ja, Wa, Ya, Za, ab, bb, db, fb, gb, hb, nb, ub, Bb, Db, Cb, Eb, Fb, Kb, Mb, Pb, Xb, Ub, nc, uc, vc;
    _.sa = function (a) {
    ...
    _.lb = function (a, b, c) {
      if (a != null && typeof a === "object" && a.pb === kb) return a;
      if (Array.isArray(a)) {
        var d = (0, _.cb)(a),
          e = d;
        e === 0 && (e |= c & 32);
    ...
    Db = function (a, b, c, d, e) {
      if (a != null) {
        if (Array.isArray(a)) a = db(a) ? void 0 : e && (0, _.cb)(a) & 2 ? a : Cb(a, b, c, d !== void 0, e);
        else if (bb(a)) {
          var f = {},
            g;
    ...
    Eb = function (a) {
      return a.pb === kb ? a.toJSON() : _.Ab(a);
    };
    Fb = function (a, b, c) {
      c = c === void 0 ? Za : c;
      if (a != null) {
        ...
        a.pb === kb && ((c = a.A), (d = (0, _.Gb)(c)), (a = d & 2 ? a : _.Hb(a, c, d, !0)));
        return a;
      }
    };
      ...
      if (c) {
        ...
        if (e) {
          b: {
            ...
            if (g)
              for (var m in g)
                if (isNaN(+m)) (e = void 0), (((e = h) != null ? e : (h = {}))[m] = g[m]);
                else if (((e = g[m]), Array.isArray(e) && (db(e) || (ab(e) && e.size === 0)) && (e = null), e == null && (k = !0), e != null)) {
                  var n = void 0;
                  ((n = h) != null ? n : (h = {}))[m] = e;
                }
            k || (h = g);
        ...
        for (; c > 0; c--) {
          h = f[c - 1];
          if (!(h == null || db(h) || (ab(h) && h.size === 0))) break;
          var r = !0;
        }
        if (f !== a || g || r) {
          if (!b) f = Array.prototype.slice.call(f, 0, c);
          else if (r || g || k) f.length = c;
          k && f.push(k);
        }
        r = f;
      } else r = a;
    ...
    _.cc = function (a, b, c, d) {
      ...
      var f = d[1],
        g = 1;
      f && f.constructor === Object && ((e.yc = f), (f = d[++g]), typeof f === "function" && ((e.Lc = !0), _.Zb != null || (_.Zb = f), _.ac != null || (_.ac = d[g + 1]), (f = d[(g += 2)])));
    ...
    _.Yb = function (a, b) {
      if (a instanceof _.y) return _.Jb(a), a.A;
    ...
    _.vb = _.fd
      ...
      : function (a, b) {
          a.ga !== void 0 ? (a.ga |= b) : Object.defineProperties(a, { ga: { value: b, configurable: !0, writable: !0, enumerable: !1 } });
        };
    _.jd = _.fd
      ? function (a, b) {
          a[gd] &= ~b;
    ...
    Bd = function (a, b, c, d) {
      ...
      d = _.Ob(a, e, c, d);
      var f;
      if (d != null && d.pb === kb) return (b = _.Lb(d)), b !== d && _.Nb(a, e, c, b), b.A;
      if (Array.isArray(d)) {
        var g = (0, _.cb)(d);
    ...
    var Kd = function (a, b) {
      ...
      if (a) {
        ...
        d
          ...
          : ((this.j = _.Pc || a.offsetX !== void 0 ? a.offsetX : a.layerX),
        ...
        this.state = a.state;
        this.g = a;
        a.defaultPrevented && Kd.ta.preventDefault.call(this);
      }
    };
    _.wc(Kd, _.Id);
    Kd.prototype.stopPropagation = function () {
      Kd.ta.stopPropagation.call(this);
      this.g.stopPropagation ? this.g.stopPropagation() : (this.g.cancelBubble = !0);
    };
    Kd.prototype.preventDefault = function () {
      Kd.ta.preventDefault.call(this);
      var a = this.g;
    ...
    _.Qd.prototype.add = function (a, b, c, d, e) {
      ...
      a || ((a = this.g[f] = []), this.h++);
      var g = Rd(a, b, d, e);
      g > -1 ? ((b = a[g]), c || (b.kb = !1)) : ((b = new Od(b, this.src, f, !!d, e)), (b.kb = c), a.push(b));
      return b;
    };
    ...
    _.Qd.prototype.Ua = function (a, b, c, d) {
      a = this.g[a.toString()];
      var e = -1;
      a && (e = Rd(a, b, c, d));
      return e > -1 ? a[e] : null;
    ...
    Yd = function (a, b, c, d, e, f) {
      ...
      d.src = a;
      d.listener = c;
      if (a.addEventListener) Jd || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(), d, e);
    ...
    _.Wd = function (a, b, c, d, e) {
      ...
      c = _.Xd(c);
      return _.Md(a) ? a.Pb(b, c, _.tc(d) ? !!d.capture : !!d, e) : Yd(a, b, c, !0, d, e);
    };
    _.ce = function (a) {
      if (typeof a === "number" || !a || a.Xa) return !1;
      var b = a.src;
      if (_.Md(b)) return b.Xc(a);
      var c = a.type,
        d = a.proxy;
  ...
  try {
    ...
    _.l.ba = function () {
      return _.hj(_.F(this, 7));
    };
    _.qj = [0, _.Dd, -5, _.lj, nj, mj, _.Dd, _.lj, mj];
  } catch (e) {
    _._DumpException(e);
  }
  try {
...
*/
    ...
    _.Qj = function (a) {
      return "function" == typeof _.Pj && a instanceof _.Pj;
    };
    _.Rj = function (a) {
      if (_.Qj(a)) return a.g;
      throw Error("O");
    };
    Tj = function (a) {
      var b = _.Oj();
      return new Sj(b ? b.createHTML(a) : a);
    };
    Uj = function (a) {
      if (a instanceof Sj) return a.g;
      throw Error("O");
    };
    Vj = function (a) {
      return a instanceof Sj ? a : Tj(String(a).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&apos;"));
    };
    _.Xj = function (a) {
      _.Wj.g.search_experiment = a;
        ...
        switch (e) {
          case 0:
            ...
            if (m < 0) {
              ...
              k = d;
            } else c.push(a.substring(k, m)), (h = m), (k = m + 1), Yj ? ((Zj.lastIndex = k), (m = Zj.exec(a))) : ((Zj.lastIndex = 0), (m = Zj.exec(a.substring(k)))), m ? ((f = ["<", m[0]]), (g = m[1]), (e = 1), (k += m[0].length)) : c.push("<");
            break;
          case 1:
            m = a.charAt(k++);
            switch (m) {
    ...
    _.ck = function (a, b, c, d) {
      if ((b = b(c || bk, d)) && b.h && a) b.h(a);
      else {
        a: if (_.tc(b)) {
          if (b.g && ((b = b.g()), b instanceof Sj)) break a;
          b = Vj("zSoyz");
        } else b = Vj(String(b));
        a.innerHTML = Uj(b);
      }
    ...
    _.dk = function (a) {
      return { id: a.Sa(), givenName: a.Id(), displayName: a.Hd(), profilePicture: a.Jd() };
    };
    Sj = function (a) {
      this.g = a;
    };
    ...
    jk.prototype.sc = null;
    jk.prototype.toString = function () {
      return this.wb;
    };
    jk.prototype.g = function () {
      if (this.tc !== _.gk) throw Error("ja");
      return Tj(this.toString());
    };
    var kk = function () {
      jk.call(this);
    };
    _.wc(kk, jk);
    kk.prototype.tc = _.gk;
    var qk, Yj, Zj, xk, ok, yk, nk, zk, tk, pk;
    _.lk = function (a) {
      if (a != null)
        switch (a.sc) {
          case 1:
    ...
    _.W = function (a) {
      return _.mk(a, _.gk) ? a : a instanceof Sj ? (0, _.U)(Uj(a).toString()) : (0, _.U)(String(String(a)).replace(nk, ok), _.lk(a));
    };
    _.U = (function (a) {
      function b(c) {
        this.wb = c;
    ...
    qk = function (a) {
      return ak(String(a), function () {
        return "";
      }).replace(pk, "&lt;");
    };
    Yj = RegExp.prototype.hasOwnProperty("sticky");
    Zj = new RegExp((Yj ? "" : "^") + "(?:!|/?([a-zA-Z][a-zA-Z0-9:-]*))", Yj ? "gy" : "g");
    _.X = function (a) {
      return _.mk(a, _.gk) ? _.rk(qk(a.wb)) : String(a).replace(nk, ok);
    };
    _.wk = function (a) {
      _.mk(a, _.hk) || _.mk(a, _.ik) ? (a = _.sk(a)) : a instanceof _.kc ? (a = _.sk(_.lc(a))) : "function" == typeof _.Pj && a instanceof _.Pj ? (a = _.sk(_.Rj(a).toString())) : ((a = String(a)), (a = tk.test(a) ? a.replace(_.uk, _.vk) : "about:invalid#zSoyz"));
      return a;
    };
    _.mk = function (a, b) {
      return a != null && a.tc === b;
    };
    xk = {
      "\x00": "&#0;",
      "\t": "&#9;",
    ...
    zk = /[\x00\x22\x27\x3c\x3e]/g;
    _.uk = /[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g;
    tk = /^[^&:\/?#]*(?:[\/?#]|$)|^https?:|^ftp:|^data:image\/[a-z0-9+-]+;base64,[a-z0-9+\/]+=*$|^blob:/i;
    _.rk = function (a) {
      return String(a).replace(zk, ok);
    };
    _.sk = function (a) {
      return String(a).replace(_.uk, _.vk);
    };
    pk = /</g;
    _.Ak = "0".codePointAt(0);
    _.Bk = RegExp("'([{}#].*?)'", "g");
    _.Ck = RegExp("''", "g");
    var bk = {};
    _.Dk = function (a) {
      a = a || {};
      return (a = a.identifier) ? "\u0110\u00e3 \u0111\u0103ng nh\u1eadp v\u1edbi t\u01b0 c\u00e1ch l\u00e0 " + a : "\u0110\u00e3 \u0111\u0103ng nh\u1eadp";
    };
    _.Ek = function (a) {
      return (0, _.U)(
        (a
          ? '<svg class="' + _.X("Bz112c") + " " + _.X("Bz112c-E3DyYd") + " " + _.X("Bz112c-uaxL4e") + '" aria-hidden=true viewBox="0 0 192 192">'
          : '<svg class="' + _.X("fFW7wc-ibnC6b-HiaYvf") + " " + _.X("zTETae-mzNpsf-Bz112c") + " " + _.X("n1UuX-DkfjY") + '" aria-hidden=true viewBox="0 0 192 192">') +
    ...
    _.S("enable_gis_oauth_button_flow_popup");
    _.S("enable_gis_oauth_button_flow_redirect");
  ...
  try {
    var Lk, Ok, Pk, Qk, Rk, Sk;
    _.Mk = function (a, b, c) {
      c = c === void 0 ? !0 : c;
      if (b && _.I(b, 7) === 2) {
        c = c === void 0 ? !0 : c;
        var d = {};
        b && (d = { Mc: _.I(b, 6), shape: _.I(b, 3), size: _.I(b, 1), text: _.I(b, 5), theme: _.I(b, 2), width: _.ib(_.F(b, 4)), Ra: c });
        _.ck(a, Jk, d);
      } else
        b && _.I(b, 10) === 2 && !_.T("disable_personalized_button")
          ? ((c = c === void 0 ? !0 : c), b && _.Ad(b, _.pj, 8) ? ((d = {}), b && (d = { shape: _.I(b, 3), text: _.I(b, 5), theme: _.I(b, 2), width: _.ib(_.F(b, 4)), fe: _.dk(_.G(b, _.pj, 8)), ge: _.ib(_.F(b, 9)), Ra: c }), _.ck(a, Kk, d)) : Lk(a, b, c))
          : Lk(a, b, c);
    };
    Lk = function (a, b, c) {
      c = c === void 0 ? !0 : c;
    ...
    Rk = function (a) {
      return _.mk(a, Pk) ? Qk(a.wb, !1) : a == null ? "" : Qk(String(a), !0);
    };
    Sk = function () {
      return (0, _.U)(
    ...
    var Yk = function (a, b, c, d, e, f, g, h) {
        ...
        return m(
          k +
            ...
            _.X(Wk(d)) +
            '"' +
            (f && !h ? ' style="width:' + _.X(Rk(f)) + 'px; max-width:400px; min-width:min-content;"' : "") +
            '><div class="' +
            _.X("nsm7Bb-HzV7m-LgbsSe-MJoBVe") +
            '"></div><div class="' +
            _.X("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") +
            " " +
            (a === 2 ? _.X("oXtfBe-l4eHX") : "") +
            '">' +
            Xk(c === 2 || c === 3) +
            (h ? "" : '<span class="' + _.X("nsm7Bb-HzV7m-LgbsSe-BPrWId") + '">' + _.W(Uk(e)) + "</span>") +
            '<span class="' +
            _.X("L6cTce") +
            '" id="button-label">' +
            g +
      ...
      Uk = function (a) {
        ...
        switch (a) {
          ...
          case 3:
            ...
            break;
          case 4:
            b += "Ti\u1ebfp t\u1ee5c s\u1eed d\u1ee5ng d\u1ecbch v\u1ee5 b\u1eb1ng Google";
            break;
          default:
            b += "\u0110\u0103ng nh\u00e2\u0323p b\u0103\u0300ng Google";
        }
        return b;
      },
      Xk = function (a) {
        return (0, _.U)((a === void 0 ? 0 : a) ? '<div class="' + _.X("nsm7Bb-HzV7m-LgbsSe-Bz112c-haAclf") + '"><div class="' + _.X("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">' + Sk() + "</div></div>" : '<div class="' + _.X("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">' + Sk() + "</div>");
      };
    var Nk = function (a) {
        a = a || {};
        var b = a.Ra;
        return (0, _.U)(Yk(a.Mc, a.size, a.theme, a.shape, a.text, a.width, b === void 0 ? !0 : b));
      },
      Jk = function (a) {
        a = a || {};
        var b = a.Ra;
        return (0, _.U)(Yk(void 0, a.size, a.theme, a.shape, a.text, void 0, b === void 0 ? !0 : b, !0));
      },
      Kk = function (a) {
        var b = a.Ra,
          c = a.fe,
        ...
        c.profilePicture ? ((b += '<img class="' + _.X("n1UuX-DkfjY") + '" src="' + _.X(_.wk(c.profilePicture)) + '" alt="'), (h = "\u1ea2nh h\u1ed3 s\u01a1 c\u1ee7a " + _.X(e ? e : c.id)), (b += _.rk(h)), (b += '">')) : (b += _.Ek());
        h = '<div class="' + _.X("nsm7Bb-HzV7m-LgbsSe-BPrWId") + '"><div class="' + _.X("ssJRIf") + '">';
        var k = "";
        if (e)
          switch (f) {
            case 4:
              k += "Ti\u1ebfp t\u1ee5c b\u1eb1ng t\u00ean " + e;
              break;
            default:
              k += "\u0110\u0103ng nh\u1eadp v\u1edbi t\u00ean " + e;
          }
        else k += Uk(f);
        b +=
          h +
          ...
          _.W(c.id) +
          "</div>" +
          (d > 1 ? (0, _.U)('<svg class="' + _.X("Bz112c") + " " + _.X("Bz112c-E3DyYd") + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"></path><path fill="none" d="M0 0h24v24H0V0z"></path></svg>') : "") +
          "</div></div>" +
          Xk(g === 2 || g === 3) +
          "</div></div>";
        c = (0, _.U)(b);
  ...
  try {
    var ge, he, je, me, ne, oe, qe, re, ue, xe, Ge, He, ke, le, ie, we, Ke, ye, ze, Ce, Ae;
    ge = function () {
      throw Error("q");
    };
    he = function (a, b) {
    ...
    ne = function (a) {
      if (typeof a === "string") return { buffer: me(a), za: !1 };
      if (Array.isArray(a)) return { buffer: new Uint8Array(a), za: !1 };
      if (a.constructor === Uint8Array) return { buffer: a, za: !1 };
      if (a.constructor === ArrayBuffer) return { buffer: new Uint8Array(a), za: !1 };
      if (a.constructor === _.zb) return { buffer: a.h() || new Uint8Array(0), za: !0 };
      if (a instanceof Uint8Array) return { buffer: new Uint8Array(a.buffer, a.byteOffset, a.byteLength), za: !1 };
      throw Error("M");
    };
    oe = function (a, b, c, d) {
      var e = c.g;
    ...
    qe = function (a, b, c, d, e) {
      var f = c.g,
        ...
        h;
      a[b] = function (k, m, n) {
        return f(k, m, n, h || (h = _.cc(pe, oe, qe, d).ob), g || (g = re(d)), e);
      };
    };
    re = function (a) {
      var b = a[se];
              ...
              (h != null && h(e, d, g)) ||
                ...
                k.Fb
                  ...
                  : ((g = k.g.g - h),
                    ...
                    (k = k.g),
                    g == 0
                      ? (g = we || (we = new _.zb(null, xe)))
                      : ((h = ye(k, g)), k.hb && k.l ? (g = k.i.subarray(h, h + g)) : ((k = k.i), (g = h + g), (g = h === g ? new Uint8Array(0) : _.xd ? k.slice(h, g) : new Uint8Array(k.subarray(h, g)))), (g = g.length == 0 ? we || (we = new _.zb(null, xe)) : new _.zb(g, xe))),
                    (h = g)),
                (g = d),
                h && (_.eb || (_.eb = Symbol()), (k = g[_.eb]) ? k.push(h) : (g[_.eb] = [h])));
            }
            f & 16384 && (0, _.vb)(d, 34);
            return !0;
          };
    ...
    _.zb.prototype.nb = function () {
      return this.g == null;
    };
    _.zb.prototype.h = function () {
      if (xe !== xe) throw Error("u");
      var a = this.g;
    ...
    var Je = [],
      ...
      Be = function (a, b, c) {
        ...
        b && ((b = ne(b)), (a.i = b.buffer), (a.l = b.za), (a.j = 0), (a.h = a.i.length), (a.g = a.j));
      };
        ...
        for (var g = null, h, k; c < a; )
          (h = b[c++]),
            h < 128
              ...
              ? c >= a
                ? ge()
                : ((k = b[c++]), h < 194 || (k & 192) !== 128 ? (c--, ge()) : f.push(((h & 31) << 6) | (k & 63)))
              : h < 240
              ? c >= a - 1
                ? ge()
                : ((k = b[c++]), (k & 192) !== 128 || (h === 224 && k < 160) || (h === 237 && k >= 160) || ((e = b[c++]) & 192) !== 128 ? (c--, ge()) : f.push(((h & 15) << 12) | ((k & 63) << 6) | (e & 63)))
              : h <= 244
              ? c >= a - 2
                ? ge()
                : ((k = b[c++]),
                  (k & 192) !== 128 || ((h << 28) + (k - 144)) >> 30 !== 0 || ((e = b[c++]) & 192) !== 128 || ((d = b[c++]) & 192) !== 128 ? (c--, ge()) : ((h = ((h & 7) << 18) | ((k & 63) << 12) | ((e & 63) << 6) | (d & 63)), (h -= 65536), f.push(((h >> 10) & 1023) + 55296, (h & 1023) + 56320)))
              : ge(),
            f.length >= 8192 && ((g = he(g, f)), (f.length = 0));
        f = he(g, f);
      }
      return f;
    };
  ...
  try {
    var ef, gf, hf, kf, lf, of, uf, vf, wf, yf, qf, Af, Df, mf, ff, jf, nf, Ef, Gf, Hf, If, Jf, Kf, Of, Lf, Pf, Qf, Rf, Sf, Tf, Uf, Vf, Wf, Xf;
    ef = function (a, b, c) {
      a[b] = c.h;
    };
    gf = function (a, b, c, d) {
      var e,
        ...
        g = c.h;
      a[b] = function (h, k, m) {
        return g(h, k, m, f || (f = _.cc(ff, ef, gf, d).ob), e || (e = hf(d)));
      };
    };
    hf = function (a) {
      var b = a[jf];
    ...
    kf = function (a, b, c) {
      ...
      if (d & 256) {
        d = a[f - 1];
        for (var p in d) (e = +p), Number.isNaN(e) || ((f = d[e]), f != null && (g = lf(c, e)) && g(b, f, e));
      }
    ...
    _.l.Zc = function (a, b) {
      if (b != null) {
        ...
        c = c === void 0 ? !1 : c;
        if (_.zc) {
          if (c && (_.yc ? !b.isWellFormed() : /(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])/.test(b))) throw Error("r");
    ...
    _.l.qe = function (a, b) {
      if (b != null) for (var c = 0; c < b.length; c++) this.Zc(a, b[c]);
    };
    ff = Symbol();
    jf = Symbol();
    ...
    Ef = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Ef(a, b[f], c, d, e);
      else (d = _.tc(d) ? !!d.capture : !!d), (c = _.Xd(c)), _.Md(a) ? a.Da(b, c, d, e) : a && (a = _.Zd(a)) && (b = a.Ua(b, c, d, e)) && _.ce(b);
    };
    _.Ff = function (a) {
      var b = a.match(_.ee);
      a = b[1];
    ...
    _.Yf = function (a) {
      ...
      var b;
      a instanceof _.Yf
        ? ((this.l = a.l), _.Zf(this, a.h), (this.v = a.getUserInfo()), (this.g = a.g), _.$f(this, a.s), (this.i = a.i), _.ag(this, Of(a.j)), (this.m = a.m))
        : a && (b = String(a).match(_.ee))
        ? ((this.l = !1), _.Zf(this, b[1] || "", !0), (this.v = Uf(b[2] || "")), (this.g = Uf(b[3] || "", !0)), _.$f(this, b[4]), (this.i = Uf(b[5] || "", !0)), _.ag(this, b[6] || "", !0), (this.m = Uf(b[7] || "")))
        : ((this.l = !1), (this.j = new Jf(null, this.l)));
    };
    ...
    ig.prototype.update = function (a, b) {
      ...
      var c = 0,
        d = this.h;
      if (typeof a === "string") for (; c < b; ) (this.i[d++] = a.charCodeAt(c++)), d == this.blockSize && (mg(this), (d = 0));
      else if (uf(a))
        for (; c < b; ) {
          var e = a[c++];
    ...
    var hg = [
      1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882,
      2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616,
    ...
    pg = function (a) {
      a = (a.g.cookie || "").split(";");
      for (var b = [], c = [], d, e, f = 0; f < a.length; f++) (e = (0, _.Ac)(a[f])), (d = e.indexOf("=")), d == -1 ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    _.l.dispatchEvent = function (a) {
      ...
      c = this.I;
      var d = a.type || a;
      if (typeof a === "string") a = new _.Id(a, c);
    ...
    _.rg.prototype.Ua = function (a, b, c, d) {
    ...
    var xg = function (a) {
        ...
        this.tb = this.G = null;
        this.Ob = "";
        this.ya = this.Lb = this.mb = this.Gb = !1;
        this.Wc = 0;
        this.rb = null;
        this.Uc = "";
        this.ce = this.Wb = !1;
        this.Bb = this.Vb = null;
      },
      yg,
      zg,
      Ag;
    ...
    _.l.send = function (a, b, c, d) {
      if (this.G) throw Error("ba`" + this.Ob + "`" + a);
      b = b ? b.toUpperCase() : "GET";
      this.Ob = a;
      this.Gb = !1;
      this.na = !0;
      this.G = new XMLHttpRequest();
      this.tb = this.ad ? ug(this.ad) : ug(vg);
      this.G.onreadystatechange = (0, _.xf)(this.Rc, this);
      this.ce &&
        "onprogress" in this.G &&
        ((this.G.onprogress = (0, _.xf)(function (g) {
          this.Qc(g, !0);
        }, this)),
        this.G.upload && (this.G.upload.onprogress = (0, _.xf)(this.Qc, this)));
      try {
        (this.Lb = !0), this.G.open(b, String(a), !0), (this.Lb = !1);
      } catch (g) {
        Cg(this);
        return;
      }
      ...
      !((0, _.Na)(zg, b) >= 0) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
      b = _.u(c);
      for (d = b.next(); !d.done; d = b.next()) (c = _.u(d.value)), (d = c.next().value), (c = c.next().value), this.G.setRequestHeader(d, c);
      this.Uc && (this.G.responseType = this.Uc);
      "withCredentials" in this.G && this.G.withCredentials !== this.Wb && (this.G.withCredentials = this.Wb);
      if ("setTrustToken" in this.G && this.Vb)
        try {
          this.G.setTrustToken(this.Vb);
        } catch (g) {}
      if ("setAttributionReporting" in this.G && this.Bb)
        try {
          this.G.setAttributionReporting(this.Bb);
        } catch (g) {}
      try {
        Dg(this), this.Wc > 0 && (this.rb = setTimeout(this.me.bind(this), this.Wc)), (this.mb = !0), this.G.send(a), (this.mb = !1);
      } catch (g) {
        Cg(this);
      }
    };
    _.l.me = function () {
      typeof _.qa != "undefined" && this.G && (this.dispatchEvent("timeout"), this.abort(8));
    };
    var Cg = function (a) {
        a.na = !1;
        a.G && ((a.ya = !0), a.G.abort(), (a.ya = !1));
        Eg(a);
        Fg(a);
      },
      Eg = function (a) {
    ...
    xg.prototype.abort = function () {
      this.G && this.na && ((this.na = !1), (this.ya = !0), this.G.abort(), (this.ya = !1), this.dispatchEvent("complete"), this.dispatchEvent("abort"), Fg(this));
    };
    xg.prototype.fa = function () {
      this.G && (this.na && ((this.na = !1), (this.ya = !0), this.G.abort(), (this.ya = !1)), Fg(this, !0));
      xg.ta.fa.call(this);
    };
    xg.prototype.Rc = function () {
      this.Jc() || (this.Lb || this.mb || this.ya ? Gg(this) : this.be());
    };
    xg.prototype.be = function () {
      Gg(this);
    };
    var Gg = function (a) {
      if (a.na && typeof _.qa != "undefined" && (!a.tb[1] || Hg(a) != 4 || a.Jb() != 2))
        if (a.mb && Hg(a) == 4) setTimeout(a.Rc.bind(a), 0);
        else if ((a.dispatchEvent("readystatechange"), Hg(a) == 4)) {
          a.na = !1;
          try {
            var b = a.Jb();
            a: switch (b) {
            ...
            if (!(d = c)) {
              var e;
              if ((e = b === 0)) {
                var f = String(a.Ob).match(_.ee)[1] || null;
                !f && _.v.self && _.v.self.location && (f = _.v.self.location.protocol.slice(0, -1));
                e = !yg.test(f ? f.toLowerCase() : "");
              }
              d = e;
            }
            d ? (a.dispatchEvent("complete"), a.dispatchEvent("success")) : Eg(a);
          } finally {
            Fg(a);
          }
        }
    };
    xg.prototype.Qc = function (a, b) {
    ...
    var Ig = function (a, b) {
      ...
      Dg = function (a) {
        a.rb && (clearTimeout(a.rb), (a.rb = null));
      };
    xg.prototype.isActive = function () {
      return !!this.G;
    };
    var Hg = function (a) {
    ...
    xg.prototype.Jb = function () {
      try {
        return Hg(this) > 2 ? this.G.status : -1;
      } catch (a) {
        return -1;
      }
    };
    ...
    xg.prototype.getResponseHeader = function (a) {
      if (this.G && Hg(this) == 4) return (a = this.G.getResponseHeader(a)), a === null ? void 0 : a;
    };
    xg.prototype.getAllResponseHeaders = function () {
      return this.G && Hg(this) >= 2 ? this.G.getAllResponseHeaders() || "" : "";
    };
    var Kg;
    Kg = function (a) {
    ...
    _.Lg = (function () {
      ...
      if (_.$c) {
        ...
        return Kg(/Chrome\/([0-9.]+)/);
      }
      if (_.ad && !_.Ka()) return Kg(/Version\/([0-9.]+)/);
      if (_.Xc || _.Yc) {
        if ((a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.ta()))) return a[1] + "." + a[2];
      } else if (_.Zc) return (a = Kg(/Android\s+([0-9.]+)/)) ? a : Kg(/Version\/([0-9.]+)/);
      return "";
    })();
    _.Mg = window;
  } catch (e) {
  ...
  try {
    ...
    _.vl = function () {
      return ![_.Fa() && !_.tl() && !_.ul(), _.Fa() && _.rl(), _.Ca()].some(function (a) {
        return a;
      });
    };
    _.xl = function () {
      var a;
      if (!(a = _.Ga() || ((_.w("iPad") || _.w("iPhone")) && !_.Ga() && !_.Fa() && !(_.za() ? 0 : _.w("Coast")) && !_.Ea() && _.w("AppleWebKit"))) && (a = _.Ka())) {
        a = _.ta();
        var b = "";
        (_.Ia() ? _.va.platform === "Windows" : _.w("Windows"))
          ...
          : _.ta().toLowerCase().indexOf("kaios") != -1
          ? ((b = /(?:KaiOS)\/(\S+)/i), (b = (a = b.exec(a)) && a[1]))
          : _.rl()
          ? ((b = /Android\s+([^\);]+)(\)|;)/), (b = (a = b.exec(a)) && a[1]))
          : _.sl() && ((b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/), (b = (a = b.exec(a)) && a[1]));
        a = _.wl(b || "", "14.4") >= 0;
      }
      return a || (_.Ea() && _.wl(_.ql(), "100") >= 0);
    };
    yl = function (a, b) {
    ...
    _.wl = function (a, b) {
      ...
      for (var d = Math.max(a.length, b.length), e = 0; c == 0 && e < d; e++) {
        ...
        do {
          ...
          c = yl(f[1].length == 0 ? 0 : parseInt(f[1], 10), g[1].length == 0 ? 0 : parseInt(g[1], 10)) || yl(f[2].length == 0, g[2].length == 0) || yl(f[2], g[2]);
          f = f[3];
          g = g[3];
        } while (c == 0);
      }
    ...
    _.tl = function () {
      return _.ua && _.va ? _.va.mobile : !_.ul() && (_.w("iPod") || _.w("iPhone") || _.w("Android") || _.w("IEMobile"));
    };
    _.ul = function () {
    ...
    zl = {};
    _.Al =
      ((zl.test_list = ["test_client_id"]),
      (zl.cross_origin_iframe_rps =
  ...
  try {
    ...
    _.wc(_.vj, _.Hd);
    var wj = [];
    _.vj.prototype.L = function (a, b, c, d) {
      Array.isArray(b) || (b && (wj[0] = b.toString()), (b = wj));
    ...
    _.vj.prototype.Pb = function (a, b, c, d) {
      return xj(this, a, b, c, d);
    };
    var xj = function (a, b, c, d, e, f) {
      if (Array.isArray(c)) for (var g = 0; g < c.length; g++) xj(a, b, c[g], d, e, f);
      else {
    ...
    _.vj.prototype.Da = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.Da(a, b[f], c, d, e);
      else (c = c || this.handleEvent), (d = _.tc(d) ? !!d.capture : !!d), (e = e || this.h || this), (c = _.Xd(c)), (d = !!d), (b = _.Md(a) ? a.Ua(b, c, d, e) : a ? ((a = _.Zd(a)) ? a.Ua(b, c, d, e) : null) : null), b && (_.ce(b), delete this.g[b.key]);
    };
    var yj = function (a) {
      rj(
        a.g,
    ...
    _.vj.prototype.fa = function () {
      _.vj.ta.fa.call(this);
      yj(this);
    };
    _.vj.prototype.handleEvent = function () {
      throw Error("ga");
    };
    _.zj = function (a, b) {
      _.rg.call(this);
    ...
    _.wc(_.zj, _.rg);
    _.zj.prototype.i = !1;
    _.zj.prototype.g = null;
    _.zj.prototype.F = function () {
      if (this.i) {
        var a = Date.now() - this.D;
        a > 0 && a < this.l * 0.8 ? (this.g = this.j.setTimeout(this.B, this.l - a)) : (this.g && (this.j.clearTimeout(this.g), (this.g = null)), this.dispatchEvent("tick"), this.i && (_.Aj(this), this.start()));
      }
    };
    _.zj.prototype.start = function () {
      this.i = !0;
  ...
  try {
    ...
    _.Dj = function (a, b) {
      if (!b.client_id) throw new _.Cj("Missing required parameter client_id.", "missing_required_parameter");
      if (!b.scope) throw new _.Cj("Missing required parameter scope.", "missing_required_parameter");
      var c = {
      ...
      a === "code" ? ((c.select_account = b.select_account), (c.ux_mode = b.ux_mode), c.ux_mode === "redirect" && (c.redirect_uri = b.redirect_uri || [location.protocol, "//", location.host, location.pathname].join(""))) : a === "token" && (c.prompt = b.prompt);
      return c;
    };
    _.Cj = function (a, b) {
      a = Error.call(this, a);
      ...
      Object.setPrototypeOf(this, _.Cj.prototype);
      this.type = b || "unknown";
    };
    _.C(_.Cj, Error);
    _.Ej = function (a, b) {
    ...
    _.Ej.prototype.i = function () {
      this.h && (_.Aj(this.h), _.A("Popup timer stopped.", "OAUTH2_CLIENT"), (this.h = void 0), (this.B = !0));
    };
    _.Fj = function (a) {
      a.v ||
        ((a.v = !0),
        window.addEventListener(
          ...
          function (b) {
            try {
              if (b.data)
                if (b.origin !== _.Ff(a.l)) _.P("Message ignored. Different origin.", "OAUTH2_CLIENT");
                else {
                  var c = JSON.parse(b.data).params;
                  c
                    ? a.m && c.id === a.m
                      ? c.clientId !== a.s.client_id
                        ? _.P("Message ignored. Client id does not match.", "OAUTH2_CLIENT")
                        : c.type !== "authResult"
                        ? _.P("Message ignored. Invalid event type.", "OAUTH2_CLIENT")
                        : ((a.m = void 0), a.i(c.authResult))
                      : _.P("Message ignored. Request id does not match.", "OAUTH2_CLIENT")
                    : _.P("Message ignored. No params in message.", "OAUTH2_CLIENT");
                }
              else _.P("Message ignored. No event data.", "OAUTH2_CLIENT");
            } catch (d) {
    ...
    _.Hj = function (a) {
      a.error_callback && a.g && !a.h && (_.P("Starting popup timer.", "OAUTH2_CLIENT"), (a.B = !1), (a.h = new _.zj(500)), new _.vj(a).L(a.h, "tick", a.D), a.h.start());
    };
    _.Ej.prototype.D = function () {
      _.A("Checking popup closed.", "OAUTH2_CLIENT");
      !this.h || this.B || (this.g && !this.g.closed) || (_.P("Popup window closed.", "OAUTH2_CLIENT"), this.error_callback && this.error_callback(new _.Cj("Popup window closed", "popup_closed")), _.Aj(this.h), (this.g = this.h = void 0));
    };
  } catch (e) {
    _._DumpException(e);
  }
  try {
    ...
    _.Ij = function (a, b, c) {
      ...
      c !== void 0 && c >= d && c <= e + a && (d = c - d < d + a - c ? c + 8 : c - a - 8);
    ...
    _.Jj = function (a, b, c) {
      ...
      if (!c || c.closed || typeof c.closed === "undefined") return _.B("Failed to open popup window on url: " + a + ". Maybe blocked by the browser?"), null;
      c.focus();
      return c;
    };
    Kj = {};
    ...
    _.Lj.prototype.toString = function () {
      return this.g;
    };
  } catch (e) {
    _._DumpException(e);
  ...
  try {
    ...
    Ip = !_.Mc && !_.Ga();
    _.Jp = function (a) {
      if (Ip && a.dataset) return a.dataset;
      var b = {};
      a = a.attributes;
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (d.name.lastIndexOf("data-", 0) == 0) {
          var e = _.Hp(d.name.slice(5));
          b[e] = d.value;
        }
      }
      return b;
  ...
  try {
    ...
    _.Lp = function () {
      ...
      (window.crypto || _.Mg.msCrypto).getRandomValues(a);
      return a[0].toString(16) + a[1].toString(16);
    };
    _.Np = function (a) {
      _.Kp(window.parent, a, _.Mp);
    };
    _.Up = function (a, b, c) {
      Op
        ? _.Q("A previous attempt has been made to verify the parent origin and is still being processed.")
        : _.Mp
        ? (_.A("Parent origin has already been verified."), b && b())
        : Pp(a)
        ? ((Qp = a), Rp(), (a = _.Lp()), _.Kp(window.parent, { command: "intermediate_iframe_ready", nonce: a }, "*"), (Op = a), (Sp = b), (Tp = c))
        : _.B("Invalid origin provided. Please provide a valid and secure (https) origin. If providing a list of origins, make sure all origins are valid and secure.");
    };
    Pp = function (a) {
      if (typeof a === "function") return !0;
      if (typeof a === "string") return Vp(a);
      if (Array.isArray(a)) {
        for (var b = 0; b < a.length; b++) if (typeof a[b] !== "string" || !Vp(a[b])) return !1;
        return !0;
      }
      return !1;
    };
    Vp = function (a) {
      try {
        ...
        if (!c.startsWith("*.")) return _.B("Invalid origin pattern. Valid patterns should start with '*.'"), !1;
        a = c;
        b = "Nb";
        if (Wp.Nb && Wp.hasOwnProperty(b)) var d = Wp.Nb;
        else {
          var e = new Wp();
          d = Wp.Nb = e;
        }
        ...
        var h = Xp(d.i, a);
        h.length > 0 && a.length > h.length && h.length != g.length && ((a = a.substr(h.length + 1)), (h += "." + a.split(".")[0]), h.length > f.length && (f = h));
        var k = f.split("").reverse().join("");
        if (c.indexOf("." + k) < 2) return _.B("Invalid origin pattern. Patterns cannot be composed of a wildcard and a top level domain."), !1;
      } catch (m) {
        return !1;
      }
      return !0;
    ...
    Rp = function () {
      Yp ||
        (Yp = _.K(window, "message", function (a) {
          a = a.g;
          if (a.data) {
            var b = a.data;
            b.sentinel === "onetap_google" &&
              b.command === "parent_frame_ready" &&
              (_.A("Message received: " + JSON.stringify(b)),
              window.parent && window.parent === a.source
                ? Op
                  ? b.nonce !== Op
                    ? _.Q("Message ignored due to invalid nonce.")
                    : (Zp(a.origin) ? ((_.Mp = a.origin), (_.$p = b.parentMode || "amp_client"), Sp && Sp()) : (_.Q("Origin verification failed. Invalid origin - " + a.origin + "."), Tp && Tp()), (Tp = Sp = Op = void 0), Yp && (_.ce(Yp), (Yp = void 0)))
                  : _.Q("Message ignored. Origin verifier is not ready, or already done.")
                : _.Q("Message ignored due to invalid source."));
          }
        }));
    };
    Zp = function (a) {
      return typeof Qp === "string"
        ? aq(Qp, a)
        : Array.isArray(Qp)
        ? Qp.some(function (b) {
            return aq(b, a);
    ...
    _.bq = function (a) {
      _.Mp ? _.Np({ command: "intermediate_iframe_resize", height: a }) : _.Q("Resize command was not sent due to missing verified parent origin.");
    };
    _.cq = function () {
      _.Mp ? _.Np({ command: "intermediate_iframe_close" }) : _.Q("Close command was not sent due to missing verified parent origin.");
    };
    _.dq = function (a) {
      _.Mp ? _.Np({ command: "set_tap_outside_mode", cancel: a }) : _.Q("Set tap outside mode command was not sent due to missing verified parent origin.");
    };
    var eq = function () {
      this.g = void 0;
      this.O = {};
    };
    eq.prototype.set = function (a, b) {
      fq(this, a, b, !1);
    };
    ...
    eq.prototype.get = function (a) {
      a: {
        for (var b = this, c = 0; c < a.length; c++)
          if (((b = b.O[a.charAt(c)]), !b)) {
            a = void 0;
            break a;
          }
        a = b;
    ...
    var gq = function (a, b) {
      ...
      for (var c in a.O) gq(a.O[c], b);
    };
    eq.prototype.Ta = function (a) {
      var b = [];
      if (a) {
    ...
    var hq = function (a, b, c) {
      a.g !== void 0 && c.push(b);
      for (var d in a.O) hq(a.O[d], b + d, c);
    };
    eq.prototype.clear = function () {
      this.O = {};
      this.g = void 0;
    };
    eq.prototype.remove = function (a) {
      ...
      for (delete b.g; c.length > 0; )
        if (((e = c.pop()), (b = e[0]), (e = e[1]), b.O[e].nb())) delete b.O[e];
        else break;
      return a;
    };
    ...
    var Wp = function () {
      ...
      jq = function (a, b, c, d) {
        ...
        a++;
        if (e == "?" || e == ",") return a;
        do (a = jq(a, b, c, d)), (e = c.charAt(a));
        while (e != "?" && e != ",");
        return a + 1;
      };
    var Qp, Yp, Op, Sp, Tp;
    _.E("google.accounts.id.intermediate.verifyParentOrigin", _.Up);
    _.E("google.accounts.id.intermediate.notifyParentResize", _.bq);
    _.E("google.accounts.id.intermediate.notifyParentClose", _.cq);
    _.E("google.accounts.id.intermediate.notifyParentDone", function () {
      _.Mp ? _.Np({ command: "intermediate_iframe_done" }) : _.Q("Done command was not sent due to missing verified parent origin.");
    });
    _.E("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.dq);
  } catch (e) {
    _._DumpException(e);
  }
  try {
    var lq = function (a, b) {
        if (_.Qj(b)) (a.href = _.Rj(b).toString()), (a.rel = "stylesheet");
        else {
          if (kq.indexOf("stylesheet") === -1) throw Error("Q`stylesheet");
          b = _.sc(b);
      ...
      mq = function () {
        var a = _.Lp().toString(),
          b = { Qb: 300, path: "/", Ub: !0 },
          c;
        if ((c = _.Fa())) c = _.wl(_.Lg, 80) >= 0;
        c && (b.Tb = "none");
        c = _.bg(location.origin);
        c.h === "http" && c.g === "localhost" && ((b.Ub = void 0), (b.Tb = void 0));
      ...
      vq = function (a, b, c) {
        ...
        if (c.hd) var n = c.hd;
        if (c.include_granted_scopes !== void 0) var p = c.include_granted_scopes;
        ...
        uq(c, "access_type", g);
        uq(c, "hd", n);
        uq(c, "response_type", f);
        uq(c, "include_granted_scopes", p === !1 ? "false" : "true");
        uq(c, "enable_granular_consent", r === !1 ? "false" : "true");
        return b + "?" + c.join("&");
      },
      wq = function (a, b) {
        var c = [];
      ...
      zq = function () {
        return !_.sl() || _.wl(_.ql(), "118") >= 0 ? _.Fa() && !_.Da() && !(_.za() ? _.xa("Opera") : _.w("OPR")) && (_.rl() || (!_.tl() && !_.ul())) && _.wl(_.ql(), "108") >= 0 : !1;
      },
      Aq = function () {
        try {
      ...
      Fq = function (a, b, c) {
        Cq = a ? a + "/gsi/log" : "https://accounts.google.com/gsi/log";
        Dq = b;
        Eq = c;
      },
      Hq = function (a, b) {
        Gq >= (b === void 0 ? 100 : b) || ((b = new _.Yf(Cq)), _.ag(b, _.cg({ client_id: Dq, as: Eq, event: a.toString() })), _.Bg(b.toString(), void 0, "POST", void 0, void 0, Cq !== "https://accounts.google.com/gsi/log"));
      },
      Lq = function (a) {
        var b = new (Function.prototype.bind.apply(Iq, [null, "onetap", a, "prompt"].concat(Jq(Kq.apply(1, arguments)))))();
        Hq(b);
      },
      Mq = function () {
        var a = new (Function.prototype.bind.apply(Iq, [null, "onetap", void 0, "closed"].concat(Jq(Kq.apply(0, arguments)))))();
        Hq(a);
      },
      Nq = function () {
        var a = new (Function.prototype.bind.apply(Iq, [null, "id", void 0, "init"].concat(Jq(Kq.apply(0, arguments)))))();
        Hq(a);
      },
      Oq = function () {
        var a = new (Function.prototype.bind.apply(Iq, [null, "onetap", void 0, "policy"].concat(Jq(Kq.apply(0, arguments)))))();
        Hq(a);
      },
      Pq = function (a) {
        a = a === null ? "null" : a === void 0 ? "undefined" : a;
        var b = _.Oj();
        return new _.Pj(b ? b.createScriptURL(a) : a);
      },
      Rq = function (a) {
        var b = b === void 0 ? "googleidentityservice" : b;
        if (!(document.getElementById(b) && Qq.get(b) && Qq.get(b))) {
          var c = new _.df(),
      ...
      Vq = function (a, b, c, d) {
        ...
        e.id = c;
        e.title = "N\u00fat \u0110\u0103ng nh\u00e2\u0323p b\u0103\u0300ng Google";
      ...
      ar = function (a, b, c) {
        ...
        var f = _.K(document, "securitypolicyviolation", function (g) {
          g = g.g;
          g.blockedURI && g.blockedURI.startsWith(e) && ((g = document.location.ancestorOrigins ? document.location.ancestorOrigins.length : 0), Oq("cspHeaderViolation", "topOrigin=" + (g > 0 ? document.location.ancestorOrigins[g - 1] : "")), _.ce(f));
        });
        b = new _.Yf(e);
        _.ag(b, _.cg({ client_id: a, as: c }));
        _.Bg(b.toString(), void 0, "POST", void 0, void 0, e !== d);
      },
      gr = function () {
        ...
        if (a) {
          ...
          a.auto_prompt && a.skip_prompt_cookie && _.qg.get(a.skip_prompt_cookie) && (a.auto_prompt = !1);
          ...
          if ((d = a.login_uri)) {
            b = _.bg(d);
            b.g || (_.Zf(b, location.protocol), (b.g = location.hostname), _.$f(b, location.port), Nq("relativeLoginUri", d), _.Q("Relative login_uri was provided. Use absolute url instead. Relative login_uri may be considered invalid in the future."));
            if (b.h !== "https" && b.g !== "localhost") throw (Nq("unsecuredLoginUri", d), new dr("Unsecured login_uri provided."));
            d = b.toString();
            a.login_uri = d;
            a.redirect_callback = er(d, c);
            a.callback || (a.callback = a.redirect_callback);
          } else a.ux_mode === "redirect" && _.B("Missing required login_uri parameter for the redirect flow.");
          d = a.native_login_uri;
          delete a.native_login_uri;
          d && a.native_callback ? _.B("Cannot set both data-native_login_uri and data-native_callback.") : d && (a.native_callback = fr(d, c, a.native_id_param || "email", a.native_password_param || "password"));
          return a;
        }
      },
      er = function (a, b) {
        return function (c) {
          c && c.credential ? qq(a, b, c.credential) : _.P("No credential found in the response.");
        };
      },
      fr = function (a, b, c, d) {
        return function (e) {
          e && e.type === "password" ? ((b[c] = e.id), (b[d] = e.password), _.sf(a, b)) : _.P("No password credential returned.");
        };
      },
      ir = function (a) {
        a = _.Jp(a);
      ...
      nr = function (a) {
        ...
        (_.T("enable_fedcm_button") || _.T("enable_fedcm_button_global_experiment")) &&
          yq("fedcmButtonToken", "Ay4A+AH4Up5DVgU1SxjgSPmFoM8Q+Iuld2nz/Sez2Z15Nlho6Jz2FpQ8RtmxCQH+t+0aI1nKtVB0Z5jNMPEcGA4AAABweyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENtQnV0dG9uTW9kZSIsImV4cGlyeSI6MTczNjgxMjgwMCwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ==");
        mr(a.I);
        return a;
      },
      or = function (a, b, c) {
      ...
      qr = function (a, b, c) {
        if (a && b) {
          var d = kr.__G_ID_CLIENT__;
          d ? pr(d, a, b, c) : _.Q("Failed to render button before calling initialize().");
        } else _.Q("Failed to render button because there is no parent or options set.");
      },
      sr = function () {
      ...
      tr = function () {
        ...
        for (var b = _.af("g_id_signout"), c = 0; c < b.length; c++) _.K(b[c], "click", sr);
        try {
          var d = gr();
          if (d) {
            var e = d.auto_prompt;
      ...
      wr = function () {
        var a = Kq.apply(0, arguments),
          b = [];
        if (a) {
          a = _.u(a);
          for (var c = a.next(); !c.done; c = a.next()) {
            var d = (c = c.value) && c.trim();
            !d && d.indexOf(" ") >= 0 ? (_.Q("In hasGrantedAllScopes() method: invalid scope [" + c + "]. Scope should be a non-empty string without space."), (c = null)) : (c = d);
            if (c === null) return _.Q("Invalid scope found."), null;
            c && b.push(c);
          }
        }
        return b;
      ...
      xr = function (a) {
        return (a = a && a.scope && a.scope.trim()) ? wr.apply(null, Jq(a.split(" "))) : null;
      },
      yr = function (a) {
        _.Qe(a, "prompt_closed", { Ce: !1 });
      },
      zr = function (a, b, c) {
        b = { Ee: b };
        c !== void 0 && (b.Fe = c);
    ...
    var kq = "alternate author bookmark canonical cite help icon license modulepreload next prefetch dns-prefetch prerender preconnect preload prev search subresource".split(" "),
      Yq = function (a, b) {
        ...
        } else _.fk(a), a.appendChild((a.nodeType == 9 ? a : a.ownerDocument || a.document).createTextNode(String(b)));
      },
      Br = { we: "signin", xe: "signup", ze: "use" },
      Cr = { se: "card", re: "bottom_sheet" },
      Dr = _.De(_.dg, _.eg),
      Er = ["debug", "info", "warn"],
      xq = {};
    var Fr = function (a) {
    ...
    var Ir = _.We(Hr);
    var Tq = function () {
      return "H\u1ed9p tho\u1ea1i \u0110\u0103ng nh\u1eadp b\u1eb1ng Google";
    };
    var Iq = function (a, b, c) {
      var d = Kq.apply(3, arguments);
      this.j = a;
      this.i = b;
      this.g = c;
      this.h = d;
    ...
    Iq.prototype.toString = function () {
      ...
      this.h && a.push.apply(a, Jq(this.h));
      return a.join(".");
    };
    var Gq = Math.floor(Math.random() * 100),
      Cq = "https://accounts.google.com/gsi/log",
      Dq,
      Eq;
    var Qq = new Map();
    var Jr = function () {
      ...
      Kr = function (a, b, c) {
        ...
        var d = { url: b.Bc, configURL: b.Ac, clientId: b.o.client_id, params: b.Ib };
        b.o.nonce && (d.nonce = b.o.nonce);
        b.o.hint && (d.loginHint = b.o.hint);
        _.T("enable_fedcm_domain_hint") && b.o.hosted_domain && (d.domainHint = b.o.hosted_domain === "*" ? "any" : b.o.hosted_domain);
        d = { context: b.o.context || "signin", providers: [d], mode: _.Ve() >= 131 ? (c === "button" ? "active" : "passive") : c };
    ...
    Jr.prototype.ra = function (a, b, c) {
      c
        ? (_.A("Processing FedCM response. callId " + this.g),
          c.login
            ? c.login({ signal: this.h.signal, nonce: a.o.nonce }).then(
                function (d) {
                  a.ra(b, d, a.Ib);
                },
                function (d) {
            ...
            : a.ra(b, c, a.Ib))
        : (_.A("FedCM credential is null. callId " + this.g), a.Aa(b, Error("Ga")));
    };
    var Mr = function () {
        this.h = !1;
      },
    ...
    var Qr = { left: 1, center: 2 },
      Rr = { rectangular: 1, square: 3, pill: 2, circle: 4 },
      Sr = { large: 1, medium: 2, small: 3 },
      Tr = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
      Ur = { outline: 1, filled_blue: 2, filled_black: 3 },
      Vr = { standard: 1, icon: 2 },
      Wr = function (a, b, c) {
        this.u = a;
        this.h = c;
        this.g = !1;
        a = new _.Tk();
        if (b && (b.logo_alignment && _.O(a, 6, Qr[b.logo_alignment]), b.shape && _.O(a, 3, Rr[b.shape]), b.size && _.O(a, 1, Sr[b.size]), b.text && _.O(a, 5, Tr[b.text]), b.theme && _.O(a, 2, Ur[b.theme]), b.type && _.O(a, 7, Vr[b.type]), b.width))
          if (typeof b.width === "number" && !isNaN(b.width)) _.$e(a, 4, Number(b.width));
      ...
      Xr = function (a) {
        if (!a.g) {
          _.Mk(a.u, a.Ia);
          var b = _.ek("nsm7Bb-HzV7m-LgbsSe", a.u);
          b &&
            a.h &&
            wq(b, function () {
              a.h && a.h.call(a);
    ...
    Wr.prototype.dispose = function () {
      if (!this.g) {
        var a = _.ek("nsm7Bb-HzV7m-LgbsSe", this.u);
        a && _.bf(a);
        this.g = !0;
    ...
    var Zr = [0, 7200, 86400, 604800, 2419200],
      $r = function (a, b, c) {
        this.i = a;
      ...
      cs = function (a, b) {
        ...
        b = JSON.stringify(f);
        c = _.rl() && _.Fa() && _.wl(_.ql(), "67") >= 0;
        _.qg.set(a.h, b, { Qb: 15552e3, path: "/", domain: a.i || void 0, Ub: c ? !0 : void 0, Tb: c ? "none" : void 0 });
      },
      ds = function (a) {
    ...
    var os = function (a) {
        ...
        var b;
        ((b = a.h) != null ? b : (a.h = ps(a.g))) || _.sa(Error("Ia"));
      },
      ps = function (a) {
        if (!a) return !1;
        try {
    ...
    var ss = new _.Lj("g_credential_picker"),
      us = function (a, b) {
        b = b === void 0 ? "i_" : b;
        var c = new qs();
        ...
        this.F = !0;
        b = new Uint8Array(16);
        (window.crypto || _.Mg.msCrypto).getRandomValues(b);
        this.m = btoa(String.fromCharCode.apply(String, Jq(b))).replace(/=+$/, "");
        this.D = new Map();
        this.ic = !1;
        this.I = new Mr();
        this.gb = this.H = !1;
    ...
    var ts = function (a, b) {
      ...
      a.Ld = b.button_url || "https://accounts.google.com/gsi/button";
      a.qc = b.picker_url || "https://accounts.google.com/gsi/select";
      a.Rd = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
      a.Cc = b.status_url || "https://accounts.google.com/gsi/status";
      a.B = _.Ff(a.Cc);
      a.Md = b.container_css_url || "https://accounts.google.com/gsi/style";
      a.Sd = b.revoke_url || "https://accounts.google.com/gsi/revoke";
      a.cb = b.fedcm_url || "https://accounts.google.com/gsi/";
      a.Fa = b.fedcm_config_url || "https://accounts.google.com/gsi/fedcm.json";
      a.lc = b.oauth2_auth_url || "https://accounts.google.com/o/oauth2/v2/auth";
      Fq(a.B, b.client_id, a.m);
      a.callback = b.callback;
      a.wc = b.redirect_callback;
      a.T = b.ux_mode === "redirect" ? "redirect" : "popup";
      c = b.ui_mode;
      (c !== void 0 && Object.values(Cr).includes(c)) || ((c = a.u === document.body), (c = (_.tl() && !_.ul()) || ((c === void 0 || c) && Aq() && window.innerWidth < 420) ? "bottom_sheet" : "card"));
      a.K = c;
      a.u = (b.prompt_parent ? b.prompt_parent : b.prompt_parent_id ? document.getElementById(b.prompt_parent_id) : null) || document.body;
      a.Qd = 9e4;
      a.Pa = b.cancel_on_tap_outside !== !1;
      a.ic = b.itp_support !== !1;
      a.s = b.use_fedcm_for_prompt === void 0 ? void 0 : !!b.use_fedcm_for_prompt;
      a.Ud = b.use_fedcm_for_button === void 0 ? void 0 : !!b.use_fedcm_for_button;
      a.bb = b.enable_redirect_uri_validation === void 0 ? void 0 : !!b.enable_redirect_uri_validation;
      c = b.state_cookie_domain;
      !c || (c != null && es.test(c)) || (c = void 0);
      a.v = new $r(c, a.Pd, b.state_cookie_name);
      a.oc(b);
      c = {};
      ...
      if (b.login_hint !== void 0 || b.hint !== void 0) c.hint = b.login_hint || b.hint;
    ...
    us.prototype.oc = function () {};
    us.prototype.mc = function () {};
    var lr = function (a) {
        a.jc ||
          ((a.jc = !0),
          _.K(
      ...
      As = function (a) {
        setTimeout(function () {
          a.Ea = _.K(document, "click", function () {
            a.Pa && xs(a, !1) && (ys(a, "tap_outside"), zs(a));
          });
        });
      },
      zs = function (a) {
        a.Ea && (_.ce(a.Ea), (a.Ea = void 0));
      },
      Bs = function (a) {
        var b;
        (b = _.T("disable_fedcm")) || (b = !zq()) || ((b = window), (b = !("IdentityCredential" in window || ("FederatedCredential" in window && b.FederatedCredential.prototype.login))));
        if (b) return !1;
        _.T("enable_account_labels") &&
          yq("accountLabelsToken", "A8Wqp9Xsd355jKrOU3SFVqNLi443LPonVpx8SpUUHoiNosN7c6tsbmtBe1piKMoMzkv6dQBydodR7MGG8Q/LFgMAAAB2eyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENtQ29udGludWVPbkJ1bmRsZSIsImV4cGlyeSI6MTczNjg5OTE5OSwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ==");
        if (_.T("enable_fedcm_iframe_and_csp_detection")) return !0;
        b = document;
        ...
        if (_.T("enable_fedcm_global_experiment")) return _.A("In FedCM global experiment group"), !0;
        if (_.T("enable_fedcm_global_control")) return _.A("In FedCM global control group"), !1;
        var c = a.o.client_id;
        b = (_.T("enable_fedcm_cross_origin_iframe") && !_.Al.cross_origin_iframe_rps.includes(c)) || _.T("enable_forced_fedcm_cross_origin_iframe");
        if ((Bq() && !a.s && !b) || (a.s && a.o.auto_select && !(_.Ve() >= 121)) || (a.o.hosted_domain && !_.T("enable_fedcm_domain_hint") && !a.s)) return !1;
        (b = a.s === !1) &&
          _.Q(
        ...
        var d = _.T("enable_fedcm_beta_launch") && a.s;
        c = (_.T("enable_fedcm_csp") && !_.Al.csp_rps.includes(c)) || _.T("enable_forced_fedcm_cross_origin_iframe");
        a = (_.T("enable_manual_fedcm_launch") || c) && (_.T("enable_fedcm_auto_reauthn") || !a.o.auto_select);
        return !b && (d || a);
      },
      Cs = function (a) {
        return zq() && a.I.h && !_.T("enable_fedcm_button_global_control") ? (_.T("enable_fedcm_button_global_experiment") ? !0 : _.T("enable_fedcm_button") ? !!a.Ud : !1) : !1;
      };
    us.prototype.ra = function (a, b, c) {
      if (b) {
        ...
        b = { credential: b && (b.idToken || d), select_by: a === "widget" ? (b && b.isAutoSelected ? "fedcm_auto" : "fedcm") : "fedcm_button" };
        Ds({ data: { announcement: _.Dk({}) } });
        _.A("FedCM response :" + JSON.stringify(b));
        a === "widget"
          ? (this.callback ? this.callback.call(this, b) : _.A("No callback found for FedCM widget flow"), Es(this, "credential_returned"))
          : (c && c.state && (b.state = c.state),
            this.T === "popup"
              ? this.callback
                ? this.callback.call(this, b)
                : _.A("No callback found for FedCM button popup flow")
              : c && c.login_uri
              ? ((a = {}), c && c.state && (a.state = c.state), qq(c.login_uri, a, b.credential))
              : this.wc
              ? this.wc.call(this, b)
              : _.A("No callback found for FedCM button redirect flow."));
      } else _.A("FedCM credential is null");
    };
    us.prototype.Aa = function (a, b) {
      _.B("FedCM get() rejects with " + b);
      a === "widget" && ys(this, "unknown_reason");
    };
    us.prototype.ja = function (a, b, c) {
      var d = this;
      ...
      _.T("enable_fedcm_csp_compliance_detection") && ar(this.g.client_id ? this.g.client_id : "", this.B, this.m);
      window.location.href.startsWith("chrome-extension://")
        ? (_.Q("Attempted to start sign in flow inside chrome extension."), Lq(b, "chromeExtension"))
        : (xs(this, !0) && Es(this, "flow_restarted"),
          a &&
            !this.gb &&
            (_.Q(
          ...
          (this.eb = c),
          this.o.client_id
            ? _.T("unsupported_browser")
              ? (_.P("One Tap is not supported in this User Agent."), this.i("browser_not_supported"), _.Re(this, "prompt_display_failed", { cause: "Unsupported user agent for one tap." }))
              : ds(this.v)
              ? (_.P("User has closed One Tap before. Still in the cool down period."), this.i("suppressed_by_user"), _.Re(this, "prompt_display_failed", { cause: "Prompt disabled by the user." }), Lq(b, "cooldown", (bs(this.v).prompt_suppress_level || 0).toString()))
              : Bs(this)
              ? ((this.H = !0),
                Or(this.I, {
                  Bc: this.cb,
                  Ac: this.Fa,
                  o: this.o,
                  Ja: !!this.o.auto_select,
                  ra: this.ra.bind(this),
                  Aa: function (e, f) {
                    if (_.T("enable_fedcm_csp_and_iframe_logs")) {
                      Fq(d.B, d.g.client_id ? d.g.client_id : "", d.m);
                      ...
                      f.message.indexOf("identity-credentials-get") >= 0 && Oq("failedWithIframeGetPermission", "iframeOrigin=" + h, "path=" + document.location.pathname, "topOrigin=" + g);
                      f.message.indexOf("Content Security Policy") >= 0 && Oq("failedWithCsp", "iframeOrigin=" + h, "path=" + document.location.pathname, "topOrigin=" + g);
                    }
                    d.Aa(e, f);
                  },
                  ae: function () {
              ...
              : Fs(this, function (e) {
                  e && _.hj(_.F(e, 3))
                    ...
                    ? (_.Ee(_.G(e, _.M, 2)),
                      ...
                      _.Re(d, "prompt_display_failed", { cause: "Error while checking for the credential status." }))
                    : e && !_.hj(_.F(e, 3)) && _.xl() && d.ic
                    ? ((d.o.is_itp = !0), Gs(d), Hs(d), Is(d, !0), As(d), delete d.o.is_itp)
                    : e && !_.hj(_.F(e, 3))
                    ? (_.A("No sessions found in the browser."), d.i("opt_out_or_no_session"), _.Re(d, "prompt_display_failed", { cause: "No signed in Google accounts available." }))
                    : (_.A("Invalid response from check credential status."), d.i("unknown_reason"), _.Re(d, "prompt_display_failed", { cause: "A network error was encountered while checking for the credential status." }));
                })
            : (_.B("Missing required parameter: client_id."), this.i("missing_client_id"), _.Re(this, "prompt_display_failed", { cause: "Missing required parameter: client_id." }), Lq(b, "noClientId")));
    };
    var pr = function (a, b, c, d) {
        ...
        b.appendChild(h);
        b = Js(a, h, c, e);
        c = { iframeId: e, wa: d, rc: c.click_listener, Mb: b, data: { nonce: g.nonce || a.g.nonce, state: g.state || a.g.state } };
        a.D.set(e, c);
        delete g.nonce;
        delete g.state;
        ...
        if (c && c.Mb) {
          ...
          requestAnimationFrame(function () {
            requestAnimationFrame(function () {
              ...
              e && Hq(new Iq("button", void 0, "rendered", "latency", Math.floor(d.i - e).toString(), Math.floor(d.j - e).toString(), Math.floor(d.startTime - e).toString()), 1);
            });
          });
        }
      },
      Ks = function (a, b) {
        ...
        if (b) {
          ...
          d
            ? d.wa
              ? (d.wa(d.data), _.A("Custom handler called for button: " + b + "."))
              : ((b = {}), d.data && (d.data.nonce && (b.nonce = d.data.nonce), d.data.state && (b.state = d.data.state)), Ms(a, b), d.rc && d.rc(Object.assign({}, d.data)))
            : _.B("A button entry was not found for the given id.");
        }
      },
      Ms = function (a, b) {
        xs(a, !0) && (Es(a, "flow_restarted"), Mq("buttonFlowStarted"));
        ...
        Cs(a)
          ? ((a.H = !0),
            Pr(a.I, {
              ...
              Ac: a.Fa,
              o: a.o,
              Ja: !!a.o.button_auto_select,
              ra: a.ra.bind(a),
              Aa: a.Aa.bind(a),
              ae: function () {
                a.H = !1;
              },
              Ib: { state: b.state, login_uri: a.o.login_uri },
            }))
          : a.T === "redirect"
          ? Ns(a)
          : Os(a);
      ...
      Ns = function (a) {
        ...
        var b = a.bb ? !1 : _.T("enable_validate_origin_in_redirect_mode");
        if (_.T("enable_gis_oauth_button_flow_redirect")) {
          b = { client_id: a.o.client_id, scope: "openid email profile", response_type: "id_token", nonce: a.o.nonce, gsiwebsdk: "gis_attributes", redirect_uri: b ? _.Ff(a.o.login_uri) : a.o.login_uri, response_mode: "form_post", prompt: "select_account" };
          ...
          Hq(new Iq("button", "redirect", "clicked", "enable_redirect_uri_validation=" + a.bb));
          _.Xe(top.location, _.qc(_.uj(a.lc, b)));
        } else _.Xe(top.location, _.qc(_.uj(a.qc, a.o)));
      },
      Os = function (a) {
        a.l = _.Lp();
        ...
        if (_.T("enable_gis_oauth_button_flow_popup")) {
          var b = { client_id: a.o.client_id, scope: "openid email profile", response_type: "id_token", nonce: a.o.nonce, gsiwebsdk: "gis_attributes", redirect_uri: a.o.origin, response_mode: "form_post", origin: a.o.origin, display: "popup", prompt: "select_account" };
          a.o.state && (b.state = a.o.state);
          var c = new _.dg();
          c = _.N(c, 1, a.o.origin);
          ...
          try {
            ...
            _.Q("validateTransformLayerPayload failed"), (m = !1);
          }
          m || Hq(new Iq("button", "popup", "clicked", "base64_gis_params_validation_failed", "origin=" + a.o.origin, "clientId=" + a.o.client_id, "gisParams=" + b.gis_params));
          if (_.Jj(_.uj(a.lc, b), ss, _.Ij())) return;
          Hq(new Iq("button", "popup", "clicked", "oauthPopupNotOpened"));
        }
        _.Jj(_.uj(a.qc, a.o), ss, _.Ij()) || Hq(new Iq("button", "popup", "clicked", "popupNotOpened"));
      },
      xs = function (a, b) {
        if (a.H)
          return (
            ...
            b.g ? ((b = b.g), _.A("Aborting FedCM flow. callId " + b.g), b.h ? (b.h.abort(), _.A("FedCM flow aborted. callId " + b.g), (b.h = void 0), (b = !0)) : (_.A("No FedCM flow to abort. callId " + b.g), (b = !1))) : (_.A("No FedCM flow to abort."), (b = !1)),
            b ? (zs(a), !0) : !1
          );
        if ($q(a.u)) var c = !a.J;
        else (c = a.u), (c = !(document.getElementById("credential_picker_iframe") || (c && document.getElementById("credential_picker_container"))));
        if (c) return !1;
        if (!b && a.F) return _.P("Cancel prompt request ignored. The prompt is in a protected state."), !1;
        $q(a.u) ? ((b = a.J) && b.parentElement ? (b.parentElement.id === "credential_picker_container" && b.parentElement.parentElement ? b.parentElement.parentElement.removeChild(b.parentElement) : b.parentElement.removeChild(b), (b = !0)) : (b = !1), (b = !b)) : (b = !Sq(a.u));
        if (b) return _.P("Failed to remove prompt iframe."), !1;
        yr(a);
        a.F = !0;
        a.J = void 0;
        zs(a);
    ...
    var Is = function (a, b, c) {
      ...
      Ps = function (a, b) {
        a.eb && a.eb.call(a, { type: b, message: void 0 });
      },
      Fs = function (a, b) {
        ...
        c = _.uj(a.Cc, c);
        nq(c, function (d) {
          d && d !== "null" ? ((d = Gr(JSON.stringify(_.ij(d)))), b(d)) : (_.B("Check credential status returns invalid response."), a.i("unknown_reason"), _.Re(a, "network", { cause: "invalid_response" }));
        });
      },
      Gs = function (a) {
        var b = a.o,
        ...
        if ((c = a.o.auto_select)) {
          c = a.v;
          var d = bs(c);
          d.disable_auto_select_to && Date.now() >= d.disable_auto_select_to && (c.Ja(), (d = bs(c)));
    ...
    var Hs = function (a) {
      ...
      ws = function (a, b) {
        if (b.origin === a.B && b.data && b.data.type === "readyForConnect")
          if ((_.A("Setup message received: " + JSON.stringify(b.data)), b.source)) {
              ...
              if (a.D.get(c)) {
                ...
                c.port1.onmessage = function (e) {
                  if (e.data && e.data.type) {
                    ...
                    var f = e.data.type;
                    if (f !== "command") _.Q("Unknown event type (" + f + ") received in the button channel.");
                    else
                        ...
                        case "resize":
                          ...
                          if (f) {
                            ...
                            if (g && g.Wa && Wq(h) && Wq(k)) {
                              ...
                              typeof g !== "number" || isNaN(g) || typeof e !== "number" || isNaN(e) || ((m.style.marginTop = g + "px"), (m.style.marginBottom = g + "px"), (m.style.marginLeft = e + "px"), (m.style.marginRight = e + "px"), Ls(a, f));
                              zr(a, k, h);
                            } else m ? _.Q("Unable to resize iframe. Invalid dimensions.") : _.Q("Unable to resize iframe. No iframe found with id: " + (f + "."));
                          }
                          break;
                        default:
            ...
            } else if (b.data.channelId && a.l && (a.l && _.rf(a.l)) === b.data.channelId) {
              c = new MessageChannel();
              c.port1.onmessage = function (e) {
                a.Ga(e);
              };
    ...
    us.prototype.Ga = function (a) {
      if (a.data && a.data.type)
        switch ((_.A("Message received: " + JSON.stringify(a.data)), a.data.type)) {
          case "response":
            var b = xs(this, !0),
              c = a.data.response,
              d = c && c.credential;
            if (d) {
              ...
              f.prompt_suppress_level && Hq(new Iq("onetap", void 0, "resetCooldown", f.prompt_suppress_level.toString()));
            ...
            b && (d ? Es(this, "credential_returned") : (ys(this, "issuing_failed"), Mq("issuingFailed")), yr(this));
            Ds(a);
            break;
          case "activity":
          ...
          case "command":
            if ((b = a.data.command))
              switch (b) {
                case "close":
                  a.data.suppress &&
                    ((a = this.v), (b = bs(a)), (b.prompt_suppress_level = Math.min(b.prompt_suppress_level + 1, 4)), (b.disable_auto_prompt = new Date().getTime() + Zr[b.prompt_suppress_level] * 1e3), Hq(new Iq("onetap", void 0, "startCooldown", b.prompt_suppress_level.toString())), cs(a, b));
                  xs(this, !0) && (ys(this, "user_cancel"), yr(this));
                  break;
                case "resize":
                  a = a.data.height;
                  if (Wq(a)) {
                    if (this.u !== document.body && $q(this.u))
                      (b = this.J) ? ((d = b.clientHeight), b.parentElement && b.parentElement !== document.body && (b.parentElement.style.height = a + "px"), (b.style.border = "none"), (b.style.height = a + "px"), (b.style.display = ""), (b = d)) : (b = void 0);
                    else
                      a: {
    ...
    us.prototype.revoke = function (a, b) {
      var c = { successful: !1 },
        d = this.o.client_id;
      d
        ? _.T("enable_fedcm_revocation_client") && "IdentityCredential" in window && _.Ve() >= 123
          ...
          : ((a = { client_id: d, hint: a }),
            this.m && (a.as = this.m),
            pq(this.Sd, a, function (e) {
              if (e && e !== "null") {
                if (((e = Ir(JSON.stringify(_.ij(e)))), (c.successful = !!_.hj(_.F(e, 3))), _.P("Revoke XHR status: " + !!c.successful), !c.successful))
                  if (_.Ad(e, _.M, 2)) {
                    e = _.G(e, _.M, 2);
                    _.Ee(e);
                    switch (_.I(e, 1)) {
              ...
              } else _.B("Invalid response is returned for revoke request."), (c.error = "invalid_response");
              b && b(c);
            }))
        : (_.B("Failed to revoke. Missing config parameter client_id."), b && ((c.error = "missing_client_id"), b(c)));
    };
    ...
    var br = {
      ...
      cr = Object.keys(br),
      hr = { parent_id: "str", size: "str", theme: "str", text: "str", shape: "str", width: "num", min_width: "num", logo_alignment: "str", type: "str", locale: "str", nonce: "str", state: "str", click_listener: "func" };
    var jr = function (a) {
      ...
      this.kc = !1;
      this.Y = !!this.h;
      this.fb = a && a.intermediate_iframe_close_callback;
      if (this.h && this.h)
        if (typeof this.h === "string") {
          if (!rq(this.h)) throw Error("Ja");
        } else if (Array.isArray(this.h)) for (a = 0; a < this.h.length; a++) if (typeof this.h[a] !== "string" || !rq(this.h[a])) throw Error("Ka");
    };
    _.C(jr, us);
    jr.prototype.oc = function (a) {
    ...
    jr.prototype.ja = function (a, b, c) {
      var d = this;
      this.Y && this.h
        ? (_.A("Verifying parent origin."),
          _.Up(this.h, function () {
            _.Mp ? _.Np({ command: "set_ui_mode", mode: d.K }) : _.Q("Set ui mode command was not sent due to missing verified parent origin.");
            _.dq(!1);
            d.xc = !1;
            us.prototype.ja.call(d, a, b, c);
          }))
        : us.prototype.ja.call(this, a, b, c);
    };
    jr.prototype.Ga = function (a) {
      us.prototype.Ga.call(this, a);
      if (this.Y && a.data && a.data.type)
        switch (a.data.type) {
          case "response":
            a.data.response && a.data.response.credential && ((this.xc = !0), _.bq(0));
            break;
          case "command":
            switch (a.data.command) {
              case "close":
                this.xc ? _.bq(0) : this.fb ? (_.bq(0), this.fb()) : _.cq();
                break;
              case "resize":
                a = a.data.height;
                typeof a === "number" && !isNaN(a) && a > 0 && _.bq(a);
                break;
              case "cancel_protect_start":
                _.dq(!1);
                break;
    ...
    _.E("google.accounts.id.setLogLevel", function (a) {
      ...
      a === void 0 || (0, _.Na)(Er, a) >= 0 ? vs(b, a, !0) : (_.B("Log level is invalid. Supported log levels are: info, warn, error. Log level set to warn by default"), vs(b, void 0, !0));
    });
    var Rs = new _.Lj("g_auth_code_window"),
      Ss = function (a) {
        _.Ej.call(this, "code", a);
    ...
    Ss.prototype.i = function (a) {
      ...
      _.Ej.prototype.i.call(this, a);
      this.callback && this.callback.call(this, a);
    };
    Ss.prototype.requestCode = function () {
      var a = this.s;
      this.T === "redirect"
        ? (_.P("Starting redirect flow.", "CODE_CLIENT"), _.sj(window.location, _.qc(vq(this.j, this.l, a))))
        : (_.P("Starting popup flow.", "CODE_CLIENT"), _.Fj(this), _.Gj(this, a), (this.g = _.Jj(vq(this.j, this.l, a), Rs, _.Ij())), !this.g && this.error_callback ? this.error_callback(new _.Cj("Failed to open popup window", "popup_failed_to_open")) : _.Hj(this));
    };
    var Ts = new _.Lj("g_auth_token_window"),
      Us = window,
      Vs = function (a) {
        _.Ej.call(this, "token", a);
        this.callback = a.callback;
    ...
    Vs.prototype.i = function (a) {
      ...
      if (a.access_token)
        if (Us.gapi && Us.gapi.client && Us.gapi.client.setToken)
          try {
            Us.gapi.client.setToken.call(this, a);
          } catch (b) {
            _.B("Set token failed. Exception encountered.", "TOKEN_CLIENT"), console.Hb(b);
          }
        else _.P("The OAuth token was not passed to gapi.client, since the gapi.client library is not loaded in your page.", "TOKEN_CLIENT");
      else _.Q("Set token failed. No access token in response.", "TOKEN_CLIENT");
      this.callback && this.callback.call(this, a);
    };
    Vs.prototype.requestAccessToken = function (a) {
      ...
      _.Fj(this);
      _.Gj(this, b);
      this.g = _.Jj(vq(this.j, this.l, b), Ts, _.Ij());
      !this.g && this.error_callback ? this.error_callback(new _.Cj("Failed to open popup window", "popup_failed_to_open")) : _.Hj(this);
    };
    _.E("google.accounts.oauth2.GoogleIdentityServicesError", _.Cj);
    _.E("google.accounts.oauth2.GoogleIdentityServicesErrorType", { ye: "unknown", te: "missing_required_parameter", ve: "popup_failed_to_open", ue: "popup_closed" });
    ...
    _.E("google.accounts.oauth2.hasGrantedAllScopes", function (a) {
      var b = Kq.apply(1, arguments),
        c = xr(a);
      return c && c.length
        ? (b = wr.apply(null, Jq(b))) && b.length
          ? (0, _.Kc)(b, function (d) {
              return (0, _.Na)(c, d) >= 0;
            })
          : !1
    ...
    _.E("google.accounts.oauth2.revoke", function (a, b) {
      ...
      oq("https://oauth2.googleapis.com/revoke", a, !1, function (c) {
        b && (_.P("callback with response: " + c), (c = c ? JSON.parse(c) : {}), (c.successful = !c.error), b(c));
      });
    });
  } catch (e) {
    _._DumpException(e);
